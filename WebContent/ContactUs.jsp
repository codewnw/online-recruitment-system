...
<table width="100%" height="707" border="1" valign="top" align="center" >
  <tr>
  ...
  <tr>
    ...
    <td width="90%" height="20" valign="top" bgcolor="#CC9966">
      ...
      <p align="center" class="style12">Email: code.wnw@gmail.com</p>
      ...
      <div style="width: 15%; float: left; margin: 5px;"><img src="images/codewnw.jpg" width="100%" height="200px" /></div>
      <div style="width: 75%; float: left; margin: 5px;"> 
      CODE WellnWill,<br>
      <label style="font: bold;">Mobile: </label>9741033355 &nbsp;&nbsp;<label style="font: bold;">Email: </label>code.wnw@gmail.com</div>

...
<body>
	<table width="100%" height="522" border="1">
 	...
 	try {
 		...
 		ResultSet rs = st
 				.executeQuery("select * from Login where Username='" + s1 + "' and Password ='" + s2 + "'");
 ...
 %>
				<form name="form1" method="post" action="savepassword.jsp"
					...
					<table width="617" height="150" border="1" align="top"
						cellpadding="1" bordercolor="#CC99FF">
						<tr>
							<td height="23" colspan="3" bordercolor="#CC6633"
								bgcolor="cc99cc"><div align="center" class="style10 style1">
						...
						<tr>
							...
							<td width="202" bordercolor="#CC6633" bgcolor="#FFFFFF"><input
								name="user" type="text" id="user" value="<%=s1%>" size="35"></td>
						...
						<tr>
							...
							<td bordercolor="#CC6633" bgcolor="#FFFFFF"><input
								name="pass" type="password" id="pass" size="35"></td>
						</tr>
						<tr>
							<td height="26" bordercolor="#CC6633" bgcolor="#9999cc"><span
								class="style15 style9"><strong>New Password </strong></span></td>
							<td bordercolor="#CC6633" bgcolor="#FFFFFF"><input
								name="newpass2" type="password" id="newpass2" size="35"></td>
						</tr>
						<tr>
							<td height="26" bordercolor="#CC6633" bgcolor="#9999cc"><span

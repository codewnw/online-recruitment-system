	...
	public boolean editInsert(String s1){
		...
		try{
			if(con==null){
				...
				System.out.println("            ...!!!...            ");
				System.out.println("JavaReport:  com.ors.bean.SaveCompEdit-- Connection has been created.");
			}
			...
			stmt.executeUpdate(sql);
				...
				flag=true;
			System.out.println("JavaReport: com.ors.bean.SaveCompEdit- Candidate table has been updated.");

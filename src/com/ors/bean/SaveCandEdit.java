	...
	public boolean editInsert(String s1){
		...
		try{
			if(con==null){
				...
				System.out.println("            ...!!!...            ");
				System.out.println("JavaReport: com.ors.bean.SaveCandEdit- Connection has been created.");
			}
			...
			//System.out.println("JavaReport: com.ors.bean.SaveCandEdit- Statement has been prepared.");
			...
			System.out.println("JavaReport: com.ors.bean.SaveCandEdit- Values have been filled to the columns.");
			i=pst.executeUpdate();
			System.out.println("JavaReport: com.ors.bean.SaveCandEdit- After updation the returning value is= "+i);
			if(i>0){
				flag=true;
				System.out.println("JavaReport: com.ors.bean.SaveCandEdit- Candidate's table STUDENTREGISTER has been updated.");
			}*/
			stmt.executeUpdate(sql);
			flag=true;
		}
		catch(Exception e){
			System.out.println("Exceptionfrom: com.ors.bean.SaveCandEdit- "+e);
		}
		return flag;
	}
}
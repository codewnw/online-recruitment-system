	...
	public boolean inExamDetails(String jid, String post, String nm){
		...
		try{
			if(con==null){
				...
				System.out.println("            ...!!!...            ");
				System.out.println("JavaReport: com.ors.bean.SaveExamDetails- Connection has been created.");
			}
			...
			pst.executeUpdate();
			flag=true;
			System.out.println("JavaReport: com.ors.bean.SaveExamDetails- Values has been inserted");
		}
		catch(Exception e){
			System.out.println("Exceptionfrom: com.ors.bean.SaveExamDetails- "+e);
		}
		return flag;
	}
}
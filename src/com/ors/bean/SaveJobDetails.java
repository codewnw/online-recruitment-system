	...
	public boolean insertJobDetails(String n){
		...
		try{
			if(con==null){
				...
				System.out.println("            ...!!!...            ");
				System.out.println("JavaReport: com.ors.bean.SaveJobDetails- Connection has been created.");
			}
			...
			pst1.executeUpdate();
			System.out.println("JavaReport: com.ors.bean.SaveJobDetails- Values in Job_Detail Table has been inserted");
			...
			pst2.executeUpdate();
			flag=true;
			System.out.println("JavaReport: com.ors.bean.SaveJobDetails- Values in Exam Table has been inserted");
			}
			catch(Exception e){
				System.out.println("Exceptionfrom: com.ors.bean.SaveJobDetails- "+e);
			}
			return flag;
		}
}
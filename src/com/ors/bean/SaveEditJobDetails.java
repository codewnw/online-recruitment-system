	...
	public boolean upJobDetails(String name){
		...
		try{
			if(con==null){
				...
				System.out.println("            ...!!!...            ");
				System.out.println("JavaReport: com.ors.bean.SaveEditJobDetails- Connection has been created.");
			}
			...
			flag=true;
			System.out.println("JavaReport: com.ors.bean.SaveEditJobDetails- JobDetails have been updated.");
		}
		catch(Exception e){
			System.out.println("Exceptionfrom: com.ors.bean.SaveEditJobDetails- "+e);
		}
		return flag;
	}
}
	...
	public boolean addQues(String jobid, String examid){
		...
		try{
			if(con==null){
				...
				System.out.println("            ...!!!...            ");
				System.out.println("JavaReport: com.ors.bean.SaveQues- Connection has been created.");
		}
		...
		pst.executeUpdate();
			flag=true;
			System.out.println("JavaReport: com.ors.bean.SaveQues- Values has been inserted");
		}
		catch(Exception e){
			System.out.println("Exceptionfrom: com.ors.bean.SaveQues- "+e);
		}
		return flag;
	}
		}

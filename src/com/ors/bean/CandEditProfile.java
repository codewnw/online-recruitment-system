	...
	public boolean candFetch(String s1){
		...
		try{
			if(con==null){
				...
				System.out.println("            ...!!!...            ");
				System.out.println("JavaReport: com.ors.bean.CandEditProfile- Connection has been created.");
			}
			...
			while(rs.next()){
				if(username.equals(rs.getString(1))){
					...
					flag=true;
					System.out.println("JavaReport: com.ors.bean.CandEditProfile- Values from STUDENTREGISTER have been fetched.");
				}
			}
		}
			catch(Exception e){
